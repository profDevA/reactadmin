    ...
    constructor(props){
        ...
        this.state={
            data:{
                ...
                datasets: [
                  {
                    label: 'Buying post number',
                    fill: false,
                    lineTension: 1,
                    backgroundColor: 'rgba(75,192,192,0.4)',
                    borderColor: 'rgba(149,149,211,1)',
                    borderCapStyle: 'butt',
                    borderDash: [],
                    borderDashOffset: 0,
          ...
          this.setState({data:{
            ...
            datasets: [
              ...
              
              {
                ...
                pointRadius: 1,
                pointHitRadius: 10,
                data: [sellsixcount, sellfivecount, sellfourcount, sellthreecount, selltwocount, sellonecount, selltodaycount]
              },
            ]
          }})
