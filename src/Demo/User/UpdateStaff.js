            ...
            <Aux>
                <Row>
                    <Col>
                        <Card>
                            <Card.Header>
                                <Card.Title as="h5">Update Staff Member Data</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                <Form>
                                    <Row>
                                        <Col>
                                            <Form.Group controlId="updateStaffForm.UserGroupSelect">
                                            ...
                                            <Form.Group controlId="updateStaffForm.FullName">
                                                <Form.Label>Full Name</Form.Label>
                                                <Form.Control type="text" placeholder="Enter your Full Name" />
                                            </Form.Group>
                                            <Form.Group controlId="updateStaffForm.Country">
                                            ...
                                            <Form.Group controlId="updateStaffForm.Region">
                                            ...
                                            <Form.Group controlId="updateStaffForm.Mobile">
                                                <Form.Label>Mobile</Form.Label>
                                                <Form.Control type="number" placeholder="Enter your mobile number" />
                                            </Form.Group>

                                            <Form.Group controlId="updateStaffForm.NewPassword">
                                                <Form.Label>Mobile</Form.Label>
                                                <Form.Control type="email" placeholder="Enter your new password" />
                                            </Form.Group>

                                            <Form.Group controlId="updateStaffForm.Status">
