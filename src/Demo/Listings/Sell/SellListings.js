...
class SellListings extends React.Component {
    constructor(props){
        super(props)
        this.state ={
            listings:[],
                                                        ...
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                                <DropdownButton as={InputGroup.Prepend} title="Action" >
                                                                    <Dropdown.Item>
                                                                        <NavLink className = "" style={{color:'#000000'}} title="Update" to={{pathname:"/listings/sell/updateselllistings", aboutProps:{
                                                                            type:data.type,
                                                                            model:data.model,
                                                                            userId:data.userId,
                                                                ...
                                                                {/* <NavLink className = "btn btn-success btn-xs" title="Update" style = {{color:"white"}} to={{pathname:"/listings/sell/updateselllistings", aboutProps:{
                                                                    type:data.type,
                                                                    model:data.model,
                                                                    userId:data.userId,
                                                                    timeStamp:data.timeStamp,
                                                                ...
                                                                <Button className = "btn btn-danger btn-xs"  title="Remove" data-toggle="tooltip"  onClick = {() => this.removeListing(data.type, data.model, data.userId, data.timeStamp)}>
