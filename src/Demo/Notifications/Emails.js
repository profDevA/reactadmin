            ...
            <Aux>
                <Row>
                    <Col>
                        <Card>
                            <Card.Header>
                                <Card.Title as="h5">Emails</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                <Form>
                                <button className="btn btn-primary shadow-2 mb-4" style={{float:"right"}}><NavLink style = {{color:"white"}} to="/notifications/addemails">Add New</NavLink></button>
                                                ...
                                                this.state.listings.map((data, index) => {
                                                    ...
                                                    return (
                                                        <tr key = {index}>
                                                            ...
                                                            <td>
                                                                <NavLink className = "btn btn-success btn-xs" title="Update" style = {{color:"white"}} to={{pathname:"/products/updateproducts", aboutProps:{
                                                                    id:data.id,
                                                                    make:data.make,
                                                                    model:data.model,
                                                                ...
                                                                <Button className = "btn btn-danger btn-xs"  title="Remove" data-toggle="tooltip" onClick = {()=>this.remove(data.id, data.make, data.model)}>
